...
public class ChatFrame {
	...
	private JLabel middleLabel = new JLabel(new ImageIcon("images\\chat_middle.jpg"));
	
	private JTextPane receiveTextPane = new JTextPane();//接收框
	private JTextArea sendTextArea = new JTextArea();//发送框
	...
	private Font font2 = new Font("font2", Font.BOLD, 20);//发送接收窗口字体
	...
	public ChatFrame(Integer openFlag) {
		this.openFlag = openFlag;
	}
	
	public ChatFrame(Socket socket, String friendname,Integer openFlag) {
		this.socket = socket;
	...
	public void sendMessage (Message msg){
		try {
			...
			Integer port_dest = Integer.parseInt(friendname);
			msg.setPort_src(port_src);	
			msg.setPort_dest(port_dest);
			oos.writeObject(msg);
			oos.flush();
